/* A1JavaParserTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. A1JavaParserTokenManager.java */
import syntaxtree.*;
import java.util.Vector;

/** Token Manager. */
@SuppressWarnings ("unused")
public class A1JavaParserTokenManager implements A1JavaParserConstants {
...
static private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public A1JavaParserTokenManager(JavaCharStream stream){
  ...
  /** Constructor. */
  public A1JavaParserTokenManager (JavaCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
