...
public class helper {
    ...
    public static Map<String, Allocate> helper(Map<String, List<String>> info,
            Map<String, MethodAllocationInfo> allocations, Map<String, Allocate> varinfo) {
        // this.info = info;
        ...
        for (String methodName : info.keySet()) {
            ...
            for (String var : variables) {
                ...
                if (alloc != null) {
                    if (alloc.spilled) {
                        MethodAllocationInfo minfo = allocations.get(methodName);
                        ...
                        do {
                            result.put(var, new Allocate("R" + i));
                        } while (i < reg);
                    }
                }
            }
...
// public class helper extends GJNoArguDepthFirst<String> {
...
// public helper(Map<String, Allocate> allo, Map<String, MethodAllocationInfo>
// details, Map<String, String> vartype) {
// this.methodDetails = details;
// this.allocation = allo;
// this.vartype = vartype;
// }

// public Map<String, Allocate> getfinal() {
// return allocation;
// }
...
// String _ret = "";
// // output.append(n.f0 + " " + n.f1.f0.toString() + " " + n.f2 + " " +
// // n.f3.f0.toString() + "{" + "\n");
// n.f0.accept(this);
// n.f1.accept(this);
// n.f2.accept(this);
...
// System.out.println("variable name " + varName + " in " + methodname + "
// methods spill: "
// + info.spilledCount + " spillindex " + alloc.spillIndex);
// // output.append(" store(" + alloc.spillIndex + ",");
// if (i < value) {
// i++;
// }
...
// String _ret = "";
// // output.append(" " + n.f0.accept(this) + "[" + n.f2.accept(this) + "] = " +
// // n.f5.accept(this) + ";");
// return _ret;
// }
