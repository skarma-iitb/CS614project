...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            // Map<String, Allocate> newallocation = hp.helper(varclass, methodDetails,
            // allocation);
            ...
            // System.out.println(entry.getKey() + " " + entry.getValue());
            // }
            // Infocollector ic = new Infocollector(varclass, allocation);
            // prettyprinter pp = new prettyprinter(allocation, vartype, methodDetails,
            // register);
            // root.accept(pp);
