...
public class prettyprinter extends GJNoArguDepthFirst<String> {
    ...
    private HashMap<String, String> varadded;
    private boolean set;
    ...
    public prettyprinter(Map<String, String> staticinfo, Map<String, String> chamedthod,
            Map<String, String> classinfo, HashMap<String, String> varadded) {
    ...
    public String visit(MethodDeclaration n) {
        ...
        indentLevel++;
        n.f7.accept(this);
        if (varadded.containsKey(cls)) {
            String clname = varadded.get(cls);
            output1.append(clname + " thh;\n");
            set = false;
        }
        int i = 0;
        n.f8.accept(this);
    ...
    public String visit(MessageSend n) {
        ...
        if (receiverType != null && isMonomorphic(receiverType)) {
            ...
            output1.append("thh =" + "(" + resultclass + ") " + receiverName + ";\n");
            ret = resultclass + "." + n.f2.f0.toString() + "(thh";
            if (n.f4.present()) {
