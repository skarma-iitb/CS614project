...
public class newoutput extends GJNoArguDepthFirst<String> {
    ...
    public newoutput(
            ...
            HashMap<String, String> possibleMethods, StringBuilder il, StringBuilder il2,
            ArrayList<String> methodinline) {
        this.inMap = inMap;
    ...
    public String visit(MethodDeclaration n) {
        ...
        n.f7.accept(this);
        int i = 0;
        if (possibleMethods.size() >= 1 && currentClass == possibleMethods.get(aar.get(i))
                && currentMethod != aar.get(i)) {
            ...
            // }
            // indent();
            output1.append(inlining2);
            indent();

            n.f8.accept(this);
            output1.append("return ").append(n.f10.f0.toString()).append(";\n");
            // output1.append("return
            // ").append(String.valueOf(methodvalue.get(aar.get(i)))).append(";\n");
            // output1.append("return
            // ").append(Integer.toString(methodvalue.get(aar.get(i)))).append(";\n");
            n.f12.accept(this);
            indentLevel--;
            indent();
            output1.append("}\n");
        ...
        n.f8.accept(this);
        indent();
        output1.append("return ").append(getConstantOrIdentifier(n.f10)).append(";\n");
        n.f12.accept(this);
        indentLevel--;
        indent();
        output1.append("}\n");
    ...
    public String visit(AssignmentStatement n) {
        ...
        output1.append(id).append(" = ").append(result).append(";\n");
        return null;
    }
    ...
    public String visit(ArrayAssignmentStatement n) {
        ...
        output1.append(id).append(exp1).append(id2).append(exp2).append(" " + exp3 + " ").append(id3).append(exp4);
        return null;
    }
    ...
    public String visit(FieldAssignmentStatement n) {
        ...
        output1.append(id1).append(exp1).append(id2).append(" " + exp2 + " ").append(id3).append(exp3 + "\n");
        return null;
    }
