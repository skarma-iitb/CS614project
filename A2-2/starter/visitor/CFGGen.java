...
public class CFGGen implements GJNoArguVisitor<String> {
   ...
   public String visit(MainClass n) {
      ...
      cfg.addMethodClassMapping(mainMethodName, mainClassName);
      BB varDecBB = new BB();
      cfg.setStartBB(varDecBB);
      cfg.setCurrentBB(varDecBB);
      // Declare Start BB
      // System.out.println("in cfggen finfing main " + varDecBB.name);
      n.f14.accept(this);
      n.f15.accept(this);
   ...
   public String visit(MethodDeclaration n) {
      ...
      n.f7.accept(this);
      n.f8.accept(this);
      // System.out.println("in cfggen finding method " + startBB.name);
      cfg.addInstruction(new Instruction(n));
      return null;
   }
   ...
   public String visit(Block n) {
      ...
      // System.out.println("CFGgen1 " + blockBB.outgoingEdges);
      // Set nextBlock as active BB
      cfg.setCurrentBB(nextBlock);
      // System.out.println("CFGgen2 " + blockBB.outgoingEdges);
      // System.out.println("in cfggen finding Block " + blockBB.name);
      return null;
   }
   ...
   public String visit(IfthenStatement n) {
      ...
      // Set nextBlock as active BB
      cfg.setCurrentBB(nextBlock);
      // System.out.println("in cfggen finding if " + nextBlock.name + condition.name
      // + trueConditionBlock.name);
      return null;
   }
   ...
   public String visit(IfthenElseStatement n) {
      ...
      cfg.setCurrentBB(nextBlock);
      // System.out
      // .println("in cfggen finfing if " + nextBlock.name + condition.name +
      // trueConditionBlock.name
      // + falseConditionBlock.name);
      return null;
   }
   ...
   public String visit(WhileStatement n) {
      ...
      cfg.setCurrentBB(nextBlock);
      // System.out
      // .println("in cfggen finfing if " + condition.name + whileBodyBlock.name +
      // nextBlock.name);
