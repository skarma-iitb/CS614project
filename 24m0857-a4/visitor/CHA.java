...
public class CHA extends GJDepthFirst<String, String> {
    ...
    private String key;
    public HashSet<String> Staticmethodinfo;
    public HashMap<String, String> resolvedMethods;
    public List<String> varreplace;

    public CHA(HashMap<String, String> cha, HashMap<String, HashSet<String>> medD) {
        methodthis = new HashMap<>();
        callmethod = new HashMap<>();
        Staticmethodinfo = new HashSet<>();
        resolvedMethods = new HashMap<>();
        this.CHA = cha;
        this.methodDetails = medD;
        objectType = new HashMap<>();
        varreplace = new ArrayList<>();
    }
    ...
    public HashMap<String, String> getResolvecall() {
        return resolvedMethods;
    }

    public List<String> getvarreplace() {
        return varreplace;
    }
    ...
    public String visit(VarDeclaration n, String a) {
        ...
        String varcheck = n.f0.accept(this, null);
        if (varcheck != null) {
            // System.out.println(varName);
            varreplace.add(varName);
    ...
    @Override
    public String visit(FormalParameterList n, String a) {
        String _ret = null;
        n.f0.accept(this, a);
        n.f1.accept(this, a);
        return _ret;
    ...
    @Override
    public String visit(FormalParameter n, String a) {
        String _ret = null;
    ...
    @Override
    public String visit(FormalParameterRest n, String a) {
        String _ret = null;
    ...
    public String visit(MessageSend n, String a) {
        ...
        String receiver = n.f0.f0.toString();
        String receiverType = objectType.get(receiver);
        // System.out.println(receiverType + " type");
        resolveMethodBindings(receiver, receiverType, methodName, resolvedMethods, visited);
    ...
    @Override
    public String visit(Type n, String a) {
        String _ret = n.f0.accept(this, a);
        return _ret;
    }
     ...
     */
    @Override
    public String visit(ArrayType n, String a) {
        String _ret = null;
        n.f0.accept(this, a);
        n.f1.accept(this, a);
        n.f2.accept(this, a);
     ...
     */
    @Override
    public String visit(BooleanType n, String a) {
        String _ret = null;
        n.f0.accept(this, a);
        return _ret;
    }
     ...
     */
    @Override
    public String visit(IntegerType n, String a) {
        String _ret = null;
        n.f0.accept(this, a);
        return _ret;
    }
    ...
    @Override
    public String visit(Identifier n, String a) {
    ...
    private void resolveMethodBindings(String receiver, String className, String methodName,
            HashMap<String, String> resolvedMethods,
            Set<String> visited) {
        ...
        if (methodDetails.containsKey(className)) {
            // System.out.println("Methods found in " + className + ": " +
            // methodDetails.get(className));
            if (methodDetails.get(className).contains(methodName)) {
                resolvedMethods.put(receiver + "." + currentClass, className + "." + methodName);
                // System.out.println(receiver + "Found method: " + className + "." +
                // methodName);
        ...
        if (found == false) {
            ...
            if (CHA.containsKey(className)) {
                String parentClass = CHA.get(className);
                // System.out.println("checking");
                if (parentClass != null) {
                    // System.out.println("Checking parent: " + parentClass);
                    resolveMethodBindings(receiver, parentClass, methodName, resolvedMethods, visited);
                }
                // System.out.println("false outside parent");
            }

        }

        // Traverse Children (avoid cycles)
        // for (String childClass : CHA.keySet()) {
        // String parent = CHA.get(childClass);
