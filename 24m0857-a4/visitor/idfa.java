...
public class idfa extends GJNoArguDepthFirst<String> {
    ...
    public idfa(Map<String, String> staticinfo, Map<String, String> chamedthod) {
    ...
    public String visit(MainClass n) {
        ...
        // output1.append(n.f0.tokenImage).append("
        // ").append(n.f1.f0.toString()).append(" {\n");
        indentLevel++;
        indent();
        // output1.append(n.f3.tokenImage + " ").append(n.f4.tokenImage + "
        // ").append(n.f5.tokenImage + " ")
    ...
    public String visit(ClassDeclaration n) {
        ...
        if (currentClass.equals(staticclass)) {
            String methodin;
            // System.out.println(methodstatic + " method static");
            if (staticinfo.containsKey(methodstatic)) {
                methodin = getStaticInfoValue(methodstatic);
    ...
    public String visit(ClassExtendsDeclaration n) {
        ...
        // output1.append(n.f0.toString() + " ").append(n.f1.f0.toString() + "
        // ").append(n.f2.toString() + " ")
        ...
        if (currentClass.equals(staticclass)) {
            if (staticinfo.containsKey(methodstatic))
                // output1.append(staticinfo.get(methodstatic));
                // output1.append("static " + methodstatic + ";\n");
                isStatic = false;
        }
        // output1.append("}\n");
    ...
    public String visit(MethodDeclaration n) {
        ...
        // output1.append(" " + n.f0.tokenImage + "
        // ").append(extractFieldType(n.f1)).append(" ")
    ...
    public String visit(WhileStatement n) {
        ...
        // output1.append(exp1 + "
        // ").append(exp2).append(id1).append(exp3).append("{\n");
        indentLevel++;
    ...
    public String visit(ArrayAssignmentStatement n) {
        ...
        // output1.append(id).append(exp1).append(id2).append(exp2).append(" " + exp3 +
        // " ").append(id3)
        // .append(exp4 + "\n");
        return null;
    }
    ...
    public String visit(ThisStoreStatement n) {
        ...
        n.f5.accept(this);
        // output1.append("
        // this").append(n.f1.tokenImage).append(n.f2.f0.toString()).append(n.f3.tokenImage)
    ...
    public String visit(MessageSend n) {
        ...
        // System.out.println(receiverName + " idfa mesgsend " + receiverType);
        String ret = "";
        ...
        if (receiverType != null && isMonomorphic(receiverType)) {
            ...
            // System.out.println(key + " idfa chamethod");
